    ...
    <GlobalStyles/>
      ...
      <section className='container'>
        ...
        <div className="col-md-6 text-center">
                                <img src="./img/items/static-4.jpg" className="img-fluid img-rounded mb-sm-30" alt=""/>
                            </div>
      ...
      { openCheckout &&
                ...
                <button className='btn-close' onClick={() => setOpenCheckout(false)}>x</button>
                    ...
                    <div className="pool-info">
                        <div className="left">
                             Talent pool name:&nbsp; <strong className="black">SQL Alpha</strong>
                        </div>
                        <div className="right">
                            Code: &nbsp;<strong className="black">SQL1092</strong>
                        </div>
                    </div>
