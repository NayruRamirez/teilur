    ...
    <GlobalStyles/>
      ...
      <section className='container'>
        ...
        <div className="col-md-6 text-center">
                                <img src="./img/items/static-7.jpg" className="img-fluid img-rounded mb-sm-30" alt=""/>
                            </div>
                            <div className="col-md-6">
                                <div className="item_info">
                                    ...
                                    <p> Expertise in Web Design UI/UX Design and Front End - Development.
                                         Extensive experience in creating initial web concepts and solutions
                                          ...
                                          user-centered design, technologies, and business strategy.</p>
      ...
      { openCheckout &&
                ...
                <button className='btn-close' onClick={() => setOpenCheckout(false)}>x</button>
                    ...
                    <div className="pool-info">
                        <div className="left">
                             Talent pool name:&nbsp; <strong className="black">UI Spiro</strong>
                        </div>
                        <div className="right">
                            Code: &nbsp;<strong className="black">UIS001</strong>
                        </div>
                    </div>
